...
Por otro lado, tomando en cuenta que MEM es un problema no lineal, Cornwell y Evans \cite{smemda} modifican el algoritmo de minimización de MEM usando Newton-Raphson.
