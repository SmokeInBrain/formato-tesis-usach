...
Si bien el sistema $(D,h,d)$ era más usado con instrumentos que sólo consistían en dos antenas. Cuando se tiene dos antenas o más, la práctica usual es utilizar el sistema de coordenadas horizontales para determinar la elevación $\mathcal{E}$, el \textit{azimuth} $\mathcal{A}$ y el largo del baseline $D$.
...
D
\begin{bmatrix}
\cos{\matcal{L}}\sin{\mathcal{E}}-\sin{\mathcal{L}}\cos{\mathcal{E}}\cos{\mathcal{A}}\\
...
Si quisieramos ver proyectar el plano $(u,v)$ en la Figura \ref{fig:ecuatorial2} bastaría que hicieramos $H=0$ en la ecuación \ref{eq:uvw} o \ref{eq:uvw2}, con esto se forma una ecuación de la elipse en el plano $(u,v)$ de la forma:
