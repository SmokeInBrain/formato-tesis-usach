...
Es necesario recalcar que para reconstruir imágenes de distintos set de datos, estos deben ser construidos con la escala de intensidad y el tamaño del píxel de la imagen resultante de estos.
...
Esto se explica de mejor forma en la Figura X.X:
