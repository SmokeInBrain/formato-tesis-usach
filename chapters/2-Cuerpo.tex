...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.65]{./images/matrixandvector.eps}
    \caption{asd}
    \label{fig:matrixandvector}
\end{figure}
%Finalmente, estas dos variables deben ser reemplazadas en $\Phi$ y $\nabla \Phi$ respectivamente.
