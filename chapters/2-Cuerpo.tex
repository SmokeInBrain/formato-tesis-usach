...
%Si bien el sistema $(D,h,d)$ era más usado con instrumentos que sólo consistían en dos antenas, cuando se tiene dos antenas o más la práctica usual es utilizar el sistema de coordenadas horizontales para determinar la elevación $\mathcal{E}$, el \textit{azimuth} $\mathcal{A}$ y el largo del baseline.
