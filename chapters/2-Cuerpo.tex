...
Como se dijo anteriormente, esta $\Phi$ es no lineal, por lo que debe ser minimizada con los algoritmos apropiados, en el caso de la solución que se propone, el método usado es el del gradiente conjugado Polak-Ribiere \citep{polak}. En el Anexo \ref{apendice:dphi} se adjunta el cálculo del gradiente de esta función.
